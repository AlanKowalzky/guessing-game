...
Fork this repository: https://github.com/rolling-scopes-school/guessing-game/

Clone your newly created repo: https://github.com/<%your_github_username%>/guessing-game/

Go to folder guessing-game
...
Select your task (JS: Guessing-game)
